...
This download includes single-cell or single-nuclei gene expression files and associated metadata for samples from project [SCPCP000021](https://scpca.alexslemonade.org/projects/SCPCP000021) in the ScPCA portal.
...
To download all samples in this project, including multiplexed libraries, if present, visit the [project page](https://scpca.alexslemonade.org/projects/SCPCP000021).
...
To cite data from SCPCP000021, please see the project abstract and publication information at [SCPCP000021 page.](https://scpca.alexslemonade.org/projects/SCPCP000021)
