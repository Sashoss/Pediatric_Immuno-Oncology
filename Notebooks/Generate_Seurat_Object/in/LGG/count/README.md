...
This download includes single-cell or single-nuclei gene expression files and associated metadata for samples from project [SCPCP000002](https://scpca.alexslemonade.org/projects/SCPCP000002) in the ScPCA portal.
...
To download all samples in this project, including multiplexed libraries, if present, visit the [project page](https://scpca.alexslemonade.org/projects/SCPCP000002).
...
To cite data from SCPCP000002, please see the project abstract and publication information at [SCPCP000002 page.](https://scpca.alexslemonade.org/projects/SCPCP000002)
