...
This download includes single-cell or single-nuclei gene expression files and associated metadata for samples from project [SCPCP000001](https://scpca.alexslemonade.org/projects/SCPCP000001) in the ScPCA portal.
...
To download all samples in this project, including multiplexed libraries, if present, visit the [project page](https://scpca.alexslemonade.org/projects/SCPCP000001).
...
To cite data from SCPCP000001, please see the project abstract and publication information at [SCPCP000001 page.](https://scpca.alexslemonade.org/projects/SCPCP000001)
